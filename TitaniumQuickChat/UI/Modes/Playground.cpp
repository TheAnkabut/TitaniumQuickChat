...
namespace Playground
{
    ...
    static const TokenInfo matchTokens[] = {
        ...
        {"Player", "[mate1]", "desc_mate1_name"},
        {"Player", "[mate1s]", "desc_mate1_score"},
        {"Player", "[mate2]", "desc_mate2_name"},
        {"Player", "[mate2s]", "desc_mate2_score"},
        {"Player", "[mate3]", "desc_mate3_name"},
        {"Player", "[mate3s]", "desc_mate3_score"},
        {"Opponent", "[opp1]", "desc_opp1_name"},
        {"Opponent", "[opp1s]", "desc_opp1_score"},
        {"Opponent", "[opp2]", "desc_opp2_name"},
        {"Opponent", "[opp2s]", "desc_opp2_score"},
        {"Opponent", "[opp3]", "desc_opp3_name"},
        {"Opponent", "[opp3s]", "desc_opp3_score"},
        {"Opponent", "[opp4]", "desc_opp4_name"},
        {"Opponent", "[opp4s]", "desc_opp4_score"},
